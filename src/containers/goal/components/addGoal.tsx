...
import {
    ...
    Radio,
    RadioGroup,
    InputLabel, MenuItem, TextareaAutosize
} from "@mui/material";
    ...
    return (
        ...
        >
                ...
                <Box sx={{ ...style, width: 600 }} className="tw-flex tw-flex-col tw-space-y-4">
                    ...
                    <TextareaAutosize placeholder="Description..." minRows={4} className="tw-bg-transparent tw-rounded-lg tw-p-4 tw-text-gray-300 tw-border tw-border-gray-300"/>
                    <Box className="tw-space-x-4 tw-text-right">
                        <Button onClick={() => handleClose()} className="">Cancel</Button>
                        <Button variant="contained" onClick={() => handleClose()} className="">Save</Button>
                    </Box>
                </Box>
        </Modal>
    )
